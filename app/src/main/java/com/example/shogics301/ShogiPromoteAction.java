 ...
 * a move.
 *
 * TODO: Update this class to reflect a promotion.
 *
...
public class ShogiPromoteAction extends GameAction {
    //Tag for logging
    private static final String TAG = "ShogiPromoteAction";
     ...
     */
    public ShogiPromoteAction(GamePlayer player, int row, int col)
    {
