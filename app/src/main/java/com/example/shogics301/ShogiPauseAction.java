...
/**
 * A game-move object that a Shogi player sends to the game to pause.
 *
 * TODO: Update this class to reflect a pause.
 * 
 * @author Steven R. Vegdahl
 * @author Hera Malik
 * @version March 2020
 */
public class ShogiPauseAction extends GameAction {
    //Tag for logging
    private static final String TAG = "ShogiPauseAction";
     ...
     */
    public ShogiPauseAction(GamePlayer player, int row, int col)
    {
