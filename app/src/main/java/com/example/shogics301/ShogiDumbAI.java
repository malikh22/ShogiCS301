 ...
 * @version July 2013
 */
public abstract class ShogiDumbAI implements GamePlayer, Tickable {
    //Tag for logging
            ...
            if (data instanceof GameInfo) { // ignore non GameInfo objects
                ...
                if (game == null) {
                    ...
                    if (myInfo instanceof BindGameInfo) {
                        ...
                        game.sendAction(new MyNameIsAction(ShogiDumbAI.this, name));
                    }
                }
                    ...
                    if (myInfo instanceof StartGameInfo) {
                        ...
                        game.sendAction(new ReadyAction(ShogiDumbAI.this));
                    }
                }
                    ...
                    game.sendAction(new GameOverAckAction(ShogiDumbAI.this));
